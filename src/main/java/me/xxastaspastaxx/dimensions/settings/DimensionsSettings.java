...
/**
 * The class creates the config file with the defined variables inside the class for easier access
 * to the config
 */
public class DimensionsSettings {
  ...
  private static HashMap<String, WorldConfiguration> worldConfigurations =
      new HashMap<String, WorldConfiguration>();

  private static FileConfiguration config;
  private static Dimensions main;

  private static ArrayList<String> ignoredSettings =
